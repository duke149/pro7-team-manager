...
export function NotificationCenter({ initialNotifications, markReadTimeoutMs = MARK_READ_TIMEOUT_MS }: { initialNotifications: readonly TeamNotification[]; markReadTimeoutMs?: number }) {
