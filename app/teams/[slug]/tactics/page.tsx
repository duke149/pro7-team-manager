...
export async function renderTacticsPage(arguments_: Arguments) {
  ...
  const matchAction = context.permissions.includes("tactics.manage") ? "Lập đội hình →" : "Xem đội hình →";
