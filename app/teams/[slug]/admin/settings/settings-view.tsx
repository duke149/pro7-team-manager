...
export function SettingsView({ team, permissions, data }: { team: TeamAccessContext["team"]; permissions: readonly PermissionCode[]; data: AdminSettingsData | null }) {
  ...
  return <div className="settings-view view-stack">
    ...
    <nav className="settings-tabs" aria-label="Các nhóm cài đặt"><a href="#team">Hồ sơ đội</a><a href="#members">Thành viên</a><a href="#notifications">Thông báo</a><a href="#payments">Nhận quỹ</a><a href="#audit">Nhật ký</a><a href="#danger">Vùng nguy hiểm</a></nav>
