...
export type TeamPaymentSettings = Readonly<{ bankCode: string; accountNumber: string; accountHolder: string; transferPrefix: string | null }>;
...
export type AdminSettingsData = Readonly<{ updatedAt: string; notificationSettings: TeamNotificationSettings; paymentSettings: TeamPaymentSettings | null; activeMembers: number; inactiveMembers: number; roles: readonly SettingsRole[]; auditEvents: readonly AuditEvent[] }>;
