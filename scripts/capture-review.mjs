...
async function main() {
  ...
  try {
    ...
    console.log("Filling login form with admin...");
    await page.fill('input[name="identifier"]', process.env.PRO7_TEST_USER || "admin");
    await page.fill('input[name="password"]', process.env.PRO7_TEST_PASSWORD || "");
